...
//create 5 filled stars in a div first, but how can fill less than 5 stars work?
//set rating state, set hover state


//all 5 stars are treated as a whole <button>
